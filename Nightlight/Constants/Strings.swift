...
public struct Strings {
    ...
    static let notEnoughTokens = "Not Enough Tokens"
    static let appreciationDescriptionWithTokens = "Let’s the person know you appreciate them and increases the appreciation on their message."
    static let appreciationDescriptionWithoutTokens = "You currently do not have enough tokens to appreciate this message. You can gain tokens by being active and helping others."
